  ...
  return (
    <header>
      <div className={"special-offer"}>
        Обратите внимание! В связи с непростой обстановкой во всем мире цены на курсы для граждан РФ просим уточнять у менеджеров по номеру телефона или по электронной почте.
      </div>
